...
class VideoResourceIT {
    ...
    public static Video createEntity(EntityManager em) {
        Video video = new Video().url(DEFAULT_URL).description(DEFAULT_DESCRIPTION).title(DEFAULT_TITLE);
        return video;
    }
    ...
    public static Video createUpdatedEntity(EntityManager em) {
        Video video = new Video().url(UPDATED_URL).description(UPDATED_DESCRIPTION).title(UPDATED_TITLE);
        return video;
    }
    ...
    void putNewVideo() throws Exception {
        ...
        updatedVideo.url(UPDATED_URL).description(UPDATED_DESCRIPTION).title(UPDATED_TITLE);
    ...
    void fullUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.url(UPDATED_URL).description(UPDATED_DESCRIPTION).title(UPDATED_TITLE);
