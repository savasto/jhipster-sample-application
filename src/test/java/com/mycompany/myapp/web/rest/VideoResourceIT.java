...
class VideoResourceIT {
    ...
    public static Video createEntity(EntityManager em) {
        Video video = new Video().url(DEFAULT_URL).description(DEFAULT_DESCRIPTION).title(DEFAULT_TITLE).videoSize(DEFAULT_VIDEO_SIZE);
        return video;
    }
    ...
    public static Video createUpdatedEntity(EntityManager em) {
        Video video = new Video().url(UPDATED_URL).description(UPDATED_DESCRIPTION).title(UPDATED_TITLE).videoSize(UPDATED_VIDEO_SIZE);
        return video;
    }
    ...
    void putNewVideo() throws Exception {
        ...
        updatedVideo.url(UPDATED_URL).description(UPDATED_DESCRIPTION).title(UPDATED_TITLE).videoSize(UPDATED_VIDEO_SIZE);
    ...
    void partialUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.url(UPDATED_URL).description(UPDATED_DESCRIPTION).title(UPDATED_TITLE).videoSize(UPDATED_VIDEO_SIZE);
