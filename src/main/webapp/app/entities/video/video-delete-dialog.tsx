...
export const VideoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.video.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.video.delete.question" interpolate={{ id: videoEntity.id }}>
