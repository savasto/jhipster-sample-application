  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.rating.home.createOrEditLabel" data-cy="RatingCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationApp.rating.home.createOrEditLabel">Create or edit a Rating</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.rating.rating')}
                id="rating-rating"
                name="rating"
                data-cy="rating"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.rating.date')}
                id="rating-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('jhipsterSampleApplicationApp.rating.user')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                ...
                name="video"
                data-cy="video"
                label={translate('jhipsterSampleApplicationApp.rating.video')}
                type="select"
              >
                <option value="" key="0" />
                {videos
