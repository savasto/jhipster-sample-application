...
export const RatingDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.rating.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.rating.delete.question" interpolate={{ id: ratingEntity.id }}>
