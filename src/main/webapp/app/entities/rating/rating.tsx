          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.rating.user">User</Translate>
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.rating.video">Video</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {ratingList.map((rating, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{rating.video ? <Link to={`video/${rating.video.id}`}>{rating.video.id}</Link> : ''}</td>
